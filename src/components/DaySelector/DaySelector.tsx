...
import { useDateSelector } from './hook'
...
export interface DaySelectorRef {
  form: FormInstance<{ day: number, custom?: number }>
}
...
const DaySelector = React.forwardRef<DaySelectorRef, DaySelectorProps>((
  _: DaySelectorProps,
  ref: React.ForwardedRef<DaySelectorRef>
) => {
  const { form, disabled, handleChange } = useDateSelector(ref)
