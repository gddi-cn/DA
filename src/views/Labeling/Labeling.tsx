...
const Labeling: React.FC = () => {
  return (
    <Box style={{ height: 'calc(100vh - 50px)', background: 'rgb(241, 245, 249)', display: 'grid', placeItems: 'center' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', rowGap: 16 }}>
        <Typography variant='h5'>即将上线，敬请期待</Typography>
        <Button component='a' href='/' variant='outlined'>返回首页</Button>
      </div>
    </Box>
  )
}
