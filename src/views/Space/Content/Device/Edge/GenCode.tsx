...
const getExtendOptions = (refresh: () => void) => {
  ...
  return (
    <div style={{ display: "flex", width: "100%" }}>
      ...
      <PrimaryBtn loading={loading} onClick={handleAdd} fw={400}>
        添加
      </PrimaryBtn>
    </div>
  );
...
const GenCode: React.FC = () => {
  ...
  return (
    <>
      <SecondaryBtn width={111} onClick={handleOpen}>
        生成注册码
      </SecondaryBtn>
      <Dialog
        open={open}
      ...
      >
        <>
          ...
          <Footer>
            {step === "group" ? (
              <>
                <SecondaryBtn width={97} onClick={handleClose}>
                  取消
                </SecondaryBtn>
                <PrimaryBtn
                  disabled={disableGen}
            ...
            {step === "code" ? (
              <>
                <SecondaryBtn width={97} onClick={handleBack}>
                  返回
                </SecondaryBtn>
                <PrimaryBtn width={97} onClick={handleClose}>
                  关闭
                </PrimaryBtn>
              </>
            ) : null}
