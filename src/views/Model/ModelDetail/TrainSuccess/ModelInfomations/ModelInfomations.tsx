...
const ModelInfomations = (): JSX.Element => {
  ...
  return (<div styleName="ModelInfomations">
          ...
          <div className="btm_content_chip_wrap">
            ...
            <div className="Progress_wrap">
              <Progress
                ...
                strokeWidth={10}
                format={percent => {
                  return (<div className="pro_text_wrap">
        ...
        <Panel header="验证集评估结果" key="1">
          ...
          <div className="btm_content_wrap">
            ...
            <div className="top_content_wrap_item result_wrap">
              ...
              <Tooltip
                title="Recall，也称检出率，在给定置信度阈值下，所有目标正样本中，模型预测正确的比率，反映模型对目标正样本的识别能力。">
                <InfoCircleOutlined/>
              </Tooltip>
            </div>
            <div className="top_content_wrap_item result_wrap">
              ...
              <Tooltip
                title="Precision，也称非误检率，在给定置信度阈值下，模型预测的所有样本中，正确识别的比率，反映模型对负样本的区分能力。">
                <InfoCircleOutlined/>
              </Tooltip>
            </div>
          </div>
