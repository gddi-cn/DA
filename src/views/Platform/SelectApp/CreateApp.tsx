...
import { Modal, Form as AntForm, Input, Select, Upload } from 'antd'
          ...
          <Container>
            <Form form={form} layout={'vertical'} preserve={false}>
              ...
              <Form.Item
                ...
                required
                rules={[
                  { required: true, message: '请选择应用模板' }
                ]}
              >
                <TemplateRadio templateList={templateList} advanceTemplateList={advanceTemplateList} />
              </Form.Item>
              <Form.Item
                name={'cover'}
                label={'封面'}
